...
class GregUiServerTests(unittest.TestCase):
    def test_ui_shell_contains_operator_controls(self) -> None:
        ...
        self.assertIn('id="generateCourseBooksFromIntake"', html)
        self.assertIn("Ready to create the course books?", html)
        self.assertIn("function generateCourseBooksFromIntake", html)
        self.assertIn("/api/generate-course-books", html)
        self.assertLess(html.index('id="materials"'), html.index('id="generateCourseBooksFromIntake"'))
        self.assertLess(html.index('id="generateCourseBooksFromIntake"'), html.index('id="marketing"'))
