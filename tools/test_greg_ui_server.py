...
class GregUiServerTests(unittest.TestCase):
    def test_ui_shell_contains_operator_controls(self) -> None:
        ...
        self.assertIn('id="marketingSaveStatus"', html)
        self.assertIn("Save edits + rebuild brochure", html)
        self.assertIn("Saving and rebuilding...", html)
        self.assertIn("Download newly rebuilt brochure", html)
        self.assertIn("currentMarketing.brochure_version", html)
        ...
        self.assertIn('data-page-link="dashboard">Admin</a>', html)
        ...
        self.assertIn('id="generateCourseMapFromIntake"', html)
        self.assertIn("Ready to create the Course Map?", html)
        self.assertIn("function generateCourseMapFromIntake", html)
        self.assertIn("Course books remain available separately in Lesson Management", html)
        self.assertIn("Course Map completed ✓", html)
        self.assertIn("generate their course books from Lesson Management", html)
        self.assertIn("intakeButton.disabled = courseMapActive || courseMapReady", html)
        self.assertLess(html.index('id="materials"'), html.index('id="generateCourseMapFromIntake"'))
        self.assertLess(html.index('id="generateCourseMapFromIntake"'), html.index('id="marketing"'))
        ...
        self.assertIn("Unfinished Courses", html)
        self.assertIn("Finished Courses", html)
        self.assertIn("function restoreSavedCourse", html)
        self.assertIn("/api/courses", html)
        self.assertIn('id="newCourse"', html)
        self.assertIn('id="completeCourse"', html)
        self.assertIn("function completeCourse", html)
        self.assertIn("/api/complete-course", html)
        self.assertIn('id="restartWorkspace"', html)
        self.assertIn('id="deleteCourse"', html)
        self.assertNotIn('id="refreshWorkspace"', html)
